...
carrying out the transaction.<br/><br/> Commonly used values:<br/><br/>
<ul> <li>http://purl.org/goodrelations/v1#ByBankTransferInAdvance</li>
...
<li>http://purl.org/goodrelations/v1#PaySwarm</li> </ul> <p>
