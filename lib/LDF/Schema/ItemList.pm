...
around json_ld_fields => sub {
    ...
    my $fields = $self->$next;
    [ @$fields, {
       'itemListElement' => $self->curry::_serializer('item_list_element'),
       'itemListOrder' => $self->curry::_serializer('item_list_order'),
       'numberOfItems' => $self->curry::_serializer('number_of_items'),
    } ]
};
