...
around json_ld_fields => sub {
    ...
    my $fields = $self->$next;
    [ @$fields, {
       'courseCode' => $self->curry::_serializer('course_code'),
       'coursePrerequisites' => $self->curry::_serializer('course_prerequisites'),
       'hasCourseInstance' => $self->curry::_serializer('has_course_instance'),
    } ]
};
